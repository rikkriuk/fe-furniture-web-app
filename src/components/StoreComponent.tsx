      ...
      <div className="pl-5 lg:pl-32 py-10 flex flex-col lg:flex-row gap-10 lg:gap-32 mt-40">
         <div className="flex flex-row lg:flex-col items-center lg:items-start justify-between lg:justify-evenly">
            ...
            <button className="hidden lg:flex items-center gap-4 mt-5 underline">
               ...
               <path d="M1 7C0.447715 7 0 7.44772 0 8C0 8.55228 0.447715 9 1 9V7ZM21.7071 8.70711C22.0976 8.31658 22.0976 7.68342 21.7071 7.29289L15.3431 0.928932C14.9526 0.538408 14.3195 0.538408 13.9289 0.928932C13.5384 1.31946 13.5384 1.95262 13.9289 2.34315L19.5858 8L13.9289 13.6569C13.5384 14.0474 13.5384 14.6805 13.9289 15.0711C14.3195 15.4616 14.9526 15.4616 15.3431 15.0711L21.7071 8.70711ZM1 9H21V7H1V9Z" fill="#23262F" />
               </svg>
            </button>
         </div>
         ...
         <div className="category-list flex gap-7 overflow-x-auto whitespace-nowrap">
            {categories?.map((item, index) => (
               ...
               <img className="w-[210px] lg:w-[275px] h-full rounded-md brightness-90" src={item.image} alt={item.title} />
               <h5 className="font-semibold text-lg lg:text-[28px] text-[#FFFFFF] absolute right-1/2 translate-x-1/2 bottom-9">{item.title}</h5>
               </div>
            ))}
         </div>
      </div>
