...
const ServicesComponent:React.FC = ():JSX.Element => {
   return (
      <div className="px-5 lg:px-32 flex justify-evenly flex-col-reverse lg:flex-row">
         <div className="mt-10">
